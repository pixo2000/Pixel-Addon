...
import me.pixel.mixin.VillagerEntityAccessor;
import me.pixel.mixin.HandledScreenAccessor;
...
public class AutoTrade extends Module {
    ...
    public AutoTrade() {
        super(Pixel.CATEGORY, "Villager Aura", "Buy and sell items to nearby villagers.");
    }
    ...
    public void clickTrade(MerchantScreenHandler handler, int index) {
        ...
        mc.player.networkHandler.sendPacket(new SelectMerchantTradeC2SPacket(index));
    }
