...
import me.pixel.mixins.IRaycastContext;
import me.pixel.utils.meteor.BODamageUtils;
...
public class RaytraceSettings extends BlackOutModule {
    public RaytraceSettings() {
        super(Pixel.SETTINGS, "Raytrace", "Global raytrace settings for every blackout module.");
    }
