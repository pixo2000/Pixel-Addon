...
import me.pixel.utils.TimerUtils1;
...
public class LogOutSpots extends Module {
    ...
    public LogOutSpots() {
        super(Pixel.CATEGORY, "log-spots-+", "Displays a box where another player has logged out at.");
        lineColor.onChanged();
    }
    ...
    private class Entry {
        ...
        public final TimerUtils1 passed = new TimerUtils1();
