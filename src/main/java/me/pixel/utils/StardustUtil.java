...
import me.pixel.mixins.ClientConnectionAccessor;
...
public class StardustUtil {
    ...
    public static boolean checkOrCreateFile(MinecraftClient mc, String fileName) {
        ...
        if (!file.exists()) {
            try {
                ...
                Pixel.LOG.error("[Pixelfust] Error creating"+file.getAbsolutePath()+"! - Why:\n"+err);
            }
        } else return true;
    ...
    public static void openFile(MinecraftClient mc, String fileName) {
        ...
        try {
            ...
            Pixel.LOG.error("Failed to open "+ file.getAbsolutePath() +"! - Why:\n"+err);
